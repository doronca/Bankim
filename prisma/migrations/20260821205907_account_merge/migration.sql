...
INSERT INTO "new_AccountMapping" ("accountNumber", "accountType", "createdAt", "currency", "displayName", "entityId", "externalId", "id", "nickname", "providerId", "providerName", "source", "updatedAt") SELECT "accountNumber", "accountType", "createdAt", "currency", "displayName", "entityId", "externalId", "id", "nickname", "providerId", "providerName", "source", "updatedAt" FROM "AccountMapping";
