    ...
    <div className="flex h-screen">
      ...
      >
        <div className="flex items-center justify-between pt-8">
          ...
          <button
            className="shrink-0 w-8 h-8 rounded-md text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 flex items-center justify-center"
        ...
        {showEntitySwitcher && !sidebarCollapsed && (
          <div>
            <label className="block text-xs text-slate-500 dark:text-slate-400 mb-1">{t.entitySwitcher}</label>
            <div className="flex items-center gap-1.5">
              ...
              <button
                className="shrink-0 w-8 h-8 rounded-md border border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800"
        ...
        <div className="mt-auto">{!sidebarCollapsed && <PreferencesPanel locale={locale} />}</div>
      </aside>
